            ...
            keymaps = {
                ...
                view = {
                    ...
                    },
                    {
                        "n",
                        "gf",
                        function() require("diffview.actions").goto_file() end,
                    ...
                    },
                    {
                        "n",
                        "<C-w>gf",
                        function() require("diffview.actions").goto_file_tab() end,
                ...
                diff1 = {
                    { "n", "g?", function() require("diffview.actions").help() end, { desc = "Open the help panel" } },
                },
                diff2 = {
                    { "n", "g?", function() require("diffview.actions").help() end, { desc = "Open the help panel" } },
                },
